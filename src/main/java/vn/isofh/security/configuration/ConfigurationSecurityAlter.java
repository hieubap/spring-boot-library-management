package vn.isofh.security.configuration;

import vn.isofh.security.configuration.jwt_config.JwtPropertiesConfiguration;
import vn.isofh.security.filter.JwtUsernamePasswordAuthenticationFilter;
import vn.isofh.security.filter.TokenVerifierFilter;
...
public class ConfigurationSecurityAlter extends WebSecurityConfigurerAdapter {
    ...
    private static final boolean isRemember_Me = false;
